...
engine = create_engine('postgresql+psycopg2://vagrant@/gifter')
...
today = datetime.date.today()
giftOne = Gifts(name="Junior Toy Saxophone", description="The Bontempi Junior Saxophone offers 4 colored keys/notes", link="http://www.amazon.com/Junior-Toy-Saxophone-by-Bontempi", image="http://ecx.images-amazon.com/images/I/51fxtTaDF9L._SY355_.jpg", status="purchased", date_added=today, givers=otherGiver, recipients=recipientTwo)
giftTwo = Gifts(name="Creativity for Kids Butterfly Necklaces", description="Create 6 beautiful butterfly necklaces", link="http://www.amazon.com/Creativity-for-Kids-Butterfly-Necklaces/dp/B00BUSZ1I2", image="http://cdn3.bigcommerce.com/s-ovsa8in/products/10623/images/13340/TNW-560274-2__06359.1440331991.650.650.jpg?c=2", status="idea", date_added=today, givers=otherGiver, recipients=recipientTwo)
